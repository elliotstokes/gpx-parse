    ...
    gpxTracks.forEach(function(currentTrack) {
      ...
      currentTrack.trkseg.forEach(function(currentSegment) {
        ...
        currentSegment.trkpt.forEach(function(trackPoint) {
          ...
          var heartrate = trackPoint.extensions.ns3:TrackPointExtension.ns3:hr; 
  				trackSegement.push(new GpxWaypoint(trackPoint.$.lat, trackPoint.$.lon, elevation, trackPoint.time, null, null, null, null,null,null,null,null,null,heartrate));
  			});
